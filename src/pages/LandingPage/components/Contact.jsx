  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          alert(
            "Su mensaje ha sido enviado con éxito, espere pronta respuesta 😊"
          );
          formulario.reset();
        },
        (error) => {
  ...
  return (
    <section id="contact" className="bg-white dark:bg-[#00786a]">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-black dark:text-white sm:text-xl">
        ...
        >
          ...
          <input
            type="submit"
            value="Send "
            className="cursor-pointer py-3 px-5 text-sm font-medium text-center bg-[#003635] text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          ></input>
        </form>
      </div>
    </section>
