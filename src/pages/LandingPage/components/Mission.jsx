...
export function Mission() {
    return (
        <section id="mission" className="bg-gray-100 h-[1000px]">
            <div className="mx-auto max-w-2xl items-center py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
                <div class="pb-10 mx-auto max-w-3xl text-center">
                    <h2 className="text-base font-semibold leading-7 text-[#00786a]">Our Mission</h2>
                ...
                <div className="pt-10 grid grid-cols-2 grid-rows-2 border-t border-gray-400 gap-4 sm:gap-6 lg:gap-8">
                    <img
