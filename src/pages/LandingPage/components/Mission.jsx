  ...
  return (
    <section id="mission" className="bg-gray-100 h-[900px]">
      <div className="mx-auto max-w-2xl items-center py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
        <div className="pb-11 mx-auto max-w-3xl text-center">
          <h2 className="pb-5 text-xl  font-bold leading-7 text-[#00786a]">
            Our Mission
          </h2>
          ...
          <p className="mt-5 text-xl text-gray-500">
            Padsy was born from the need to obtain therapeutic services in an
            increasingly dynamic reality, where not everyone can afford to
            travel to get a quality service. We take proud in letting our
            costumers, let them be patients or doctors, get the service they
            need: where they want, when they want, as they want.
          </p>
        </div>
