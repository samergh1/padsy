...
import { ChatPageUrl, LandingPageUrl, RegisterPageUrl } from "../../constants/urls"
...
export function LoginPage() {
  ...
  const onFail = () => {
    navigate(RegisterPageUrl);
  }

  const handleGoogleClick = () => {
    signInWithGoogle({onSuccess:onSuccess, onFail:onFail});
  }
      ...
      <div className="bg-[#efefef] flex flex-col p-6 rounded-lg shadow-md w-3/4 sm:w-1/2">
        ...
        <div className="flex flex-col justify-center items-center mt-10">
          <button
              ...
              className="bg-[#00786A] text-center w-1/2 sm:1/3 hover:scale-105 transition-all rounded-md text-white py-2 px-4"
          >
              Submit
          </button>
        </div>
