                    ...
                    <div className="flex gap-10 bg-white w-full h-full border-b p-10">
                        ...
                        <div className="flex flex-col w-full">
                            <div className="flex justify-between items-center mb-16">
                                ...
                                <button className="bg-[#00786A] text-center text-white px-6 py-2 hover:scale-105 transition-all rounded-md">Edit profile</button>
                            </div>
                ...
                <div className="flex gap-10 bg-white w-full h-full border-b p-10">
                    <div className="flex flex-col w-full">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <button className="bg-[#00786A] text-center text-white px-6 py-2 hover:scale-105 transition-all rounded-md">View all</button>
                        </div>
