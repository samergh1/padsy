    ...
    const handleForms = () => {
        switch (page) {
            case 0: {
                return (
                    <div>
                        <AccountDetailsDoctor formValues={values} onChange={onChange}></AccountDetailsDoctor>
                    </div>
                );
            }
            case 1: {
                return (
                    <div>
                        <PersonalDetailsDoctor formValues={values} onChange={onChange}></PersonalDetailsDoctor>
                    </div>
                );
            }
            case 2: {
                return (
                    <div>
                        <ProfessionalDetailsDoctor formValues={values} onChange={onChange}></ProfessionalDetailsDoctor>
                    </div>
                );
            }
            default:
