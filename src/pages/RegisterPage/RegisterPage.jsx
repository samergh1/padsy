  ...
  return (
    <>
      <div className="sm:grid sm:grid-cols-5 w-screen h-screen">
        ...
        <div className="flex flex-col bg-white col-span-4 p-12">
          <div className="bg-[#F8F8F8] justify-center items-center w-full h-full p-12">
            <div>
            ...
            <form className="mt-2 space-y-6" action="#" method="POST">
              ...
              <div className="-space-y-px shadow-sm flex flex-col gap-4">
                <div>
