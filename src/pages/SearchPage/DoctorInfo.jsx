    ...
    <>
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-200 dark:border-gray-400">
        ...
        <div className="flex flex-col items-center pb-10">
          ...
          <h4 className="mb-1 text-xl  text-black font-medium  ">
            500$
            {/* {selectedDoctor.cost} */}
          </h4>
      ...
      <h3 className="text-black pt-20">Reviews</h3>
      <div className="flex items-start py-3">
        ...
        <div className="ml-6">
          ...
          <div className="flex items-center mt-1">
            <div>
              <h4 className="text-xs text-black pr-3">Sesion Quality</h4>
            </div>
            <svg
          ...
          <div className="mt-3">
            <span className="font-bold">Exelente Atencion!</span>
            <p className="mt-1">
